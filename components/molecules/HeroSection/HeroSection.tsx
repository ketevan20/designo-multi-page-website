...
const HeroSection = () => {
    return (
        <div className='w-full h-screen bg-[rgba(231,129,107,1)] rounded-[15px] px-24 flex items-center relative'>
            <img src={'/home/desktop/bg-pattern-hero-home.svg'} className='absolute right-0 top-0 bottom-0' />
            ...
            <img src="/home/desktop/phone2.svg" alt="" className='absolute bottom-0 right-0 object-cover max-h-[90%]' />
