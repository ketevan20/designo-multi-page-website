...
const Deal = () => {
    return (
        <motion.div
            ...
            className='w-screen left-1/2 -translate-x-1/2 sm:w-full bg-[rgba(253,243,240,1)] sm:rounded-[15px] flex md:flex-row flex-col-reverse overflow-hidden relative z-30'>
