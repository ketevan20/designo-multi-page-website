...
const Card = ({image, text, title}: CardProps) => {
    return (
        <div className='group hover:cursor-pointer w-full h-full bg-[rgba(253,243,240,1)] rounded-[15px] overflow-hidden flex md:flex-col flex-col sm:flex-row hover:bg-[rgba(231,129,107,1)] transition-colors duration-300'>
